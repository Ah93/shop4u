...
export class ProductViewPage implements OnInit {
  ...
  constructor(public nav: NavController, public alertCtrl: AlertController, private authService: AuthenticateService) {
